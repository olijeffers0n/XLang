package com.oli.xlang.versionchecker;
...
public final class VersionChecker {
    ...
    private VersionChecker(@NotNull JavaPlugin plugin, int pluginID, @NotNull VersionScheme versionScheme) {
        this.plugin = plugin;
     ...
     */
    @NotNull
    public static VersionChecker init(@NotNull JavaPlugin plugin, int pluginID, @NotNull VersionScheme versionScheme) {
        Preconditions.checkArgument(plugin != null, "Plugin cannot be null");
        Preconditions.checkArgument(pluginID > 0, "Plugin ID must be greater than 0");
        Preconditions.checkArgument(versionScheme != null, "null version schemes are unsupported");

        return (instance == null) ? instance = new VersionChecker(plugin, pluginID, versionScheme) : instance;
    }
     ...
     */
    @NotNull
    public static VersionChecker init(@NotNull JavaPlugin plugin, int pluginID) {
     ...
     * {@link VersionChecker#requestUpdateCheck()}.
     */
    public final class UpdateResult {
        ...
        { // An actual use for initializer blocks. This is madness!
            VersionChecker.this.lastResult = this;
        }
